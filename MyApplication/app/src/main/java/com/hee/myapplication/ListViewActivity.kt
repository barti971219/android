...
class ListViewAdapter(
    ...
    override fun getItem(position: Int): Any {
        // 전체 데이터중에서 해당번째(position)의 데이터를 리턴
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        holder.carImage?.setImageDrawable(
            context.resources.getDrawable(R.drawable.exercise)
        )
...
//
//        val car = carList.get(position)
//        carImage.setImageDrawable(context.resources.getDrawable(R.drawable.exercise, context.theme))
